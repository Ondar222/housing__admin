                    ...
                    <Item>
                        <Box sx={{ display: "flex", flexDirection: "row", justifyContent: "space-between", width: "67%" }}>
                            ...
                            <Typography variant="subtitle1" gutterBottom sx={{ fontSize: "11px", fontWeight: "bold", color: "blue", display: "flex", flexDirection: "row", gap: "10px" }}>
                                <img src="./public/img/official-icon.png" alt="" width={20} height={20} />
                                800
                            </Typography>
                        </Box>
                        ...
                        <Box>
                            ...
                            <Box sx={{ display: "flex", flexDirection: 'row', justifyContent: "space-between" }}>
                                ...
                                <Box sx={{ display: "flex", flexDirection: 'row', justifyContent: "start" }}>
                                    <Avatar sx={{ width: "32px", height: "32px" }} alt="Travis Howard" src="./public/img/avatar1.png" />
                                    <Avatar sx={{ width: "32px", height: "32px" }} alt="Agnes Walker" src="./public/img/avatar3.png" />
                                    <Avatar sx={{ width: "32px", height: "32px" }} alt="Agnes Walker" src="./public/img/Other.png" />
