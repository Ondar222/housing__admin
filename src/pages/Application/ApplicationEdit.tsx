...
import { Participant, ParticipantFormData, ParticipantFormFields, ParticipantFormI, ParticipantType } from "../../types/Participant";
...
const ApplicationEditPage: FC = () => {
    ...
    const { register, unregister, handleSubmit, watch, control, reset } = useForm<ParticipantFormFields>({
        defaultValues: {
            applicant: {},
            spouse: {},
            family: {
            ...
            application: [{
                housing_program: 1,
                intention: ApplicationIntention.CONSTRUCTION
            }]
        }
    });
    const isMarried: boolean = watch("family.is_married");
    const isLarge: boolean = watch("family.is_large")
    ...
    const onSubmit: SubmitHandler<EditPageForm> = async (values) => {
        ...
        const data: ParticipantFormData = {
            ...
            family: {
                is_married: values.family.isMarried,
